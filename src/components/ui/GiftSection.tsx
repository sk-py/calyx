  ...
  const contentSections: ContentSection[] = [
    {
      ...
      description:
        "<p>With up to <b>35% oil concentration</b>, Calyx perfumes are built for projection and longevity — lasting <b>8-12</b> hours to accompany you through every moment.</p>",
    ...
    },
    {
      ...
      description:
        "<p>Every Calyx creation is <b>more than a perfume</b> — it's a vessel of emotions, places and moments. Every note is chosen to awaken a memory, carrying you back to times worth reliving.</p>",
      image: "/assets/all_images/timeless 1.2.png",
      imageAlt: "Elegant perfume",
    },
    {
      heading: "A SCENT YOU'LL KNOW INSTANTLY",
      description:
        "Our perfumes <b>achieve up to 90–95% similarity</b>. Experience the same elegance and familiarity of world-renowned perfumes, captured with precision.",
