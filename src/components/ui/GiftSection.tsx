...
//   return (
//     <div ref={containerRef} className="relative w-full h-[500vh] bg-black text-white overflow-hidden">
//       {/* Fixed content container */}
//       <div className="sticky top-0 w-full h-screen flex items-center justify-center">
//         <div className="flex flex-col md:flex-row items-center justify-center p-8 md:p-16 w-full max-w-7xl mx-auto">
//           {/* Left Text Section */}
//           <div className="flex flex-col items-center md:items-start text-center md:text-left w-full md:w-1/2 mb-12 md:mb-0 md:pr-12 relative">
//             {contentSections.map((section, index) => (
//               <div key={index} className="absolute inset-0 flex flex-col justify-center">
//                 <div ref={(el) => (headingRefs.current[index] = el)} className="mb-6">
...
//                   className="text-sm md:text-base max-w-md mb-20 min-h-fit text-gray-300 leading-relaxed"
//                 >
//                   {section.description}
//                 </p>

//                 {index === 0 && (
//                   <button className="px-8 py-3 border border-white text-white text-sm uppercase tracking-wider hover:bg-white hover:text-black transition-colors w-fit">
//                     Discover
//                   </button>
//                 )}
//               </div>
...
//           {/* Right Image Section */}
//           <div className="relative w-full md:w-1/2 flex items-center justify-center h-[400px] md:h-[500px] lg:h-[600px]">
//             <div className="w-[200px] h-[350px] md:w-[250px] md:h-[400px] lg:w-[300px] lg:h-[450px] rounded-t-full overflow-hidden bg-gradient-to-t from-gray-900 to-gray-700 relative">
//               {contentSections.map((section, index) => (
//                 <img
//                   key={index}
  ...
  const contentSections: ContentSection[] = [
    {
      heading: "CRAFTED TO LAST",
      description:
        "With up to 35% oil concentration, Calyx perfumes are built for projection and longevity — lasting 8-12 hours to accompany you through every moment.",
      image:
        "https://images.unsplash.com/photo-1622618991746-fe6004db3a47?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      imageAlt: "Luxury perfume bottle",
    },
